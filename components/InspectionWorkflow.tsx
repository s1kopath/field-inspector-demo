    ...
    setTimeout(() => {
      ...
      if (success) {
        setInspection((prev) => ({
          ...
          location: property.name + " - Equipment Zone A",
          currentStep: "form",
        }));
      } else {
        setInspection((prev) => ({
  ...
  const scanQR = () => {
    ...
    setTimeout(() => {
      ...
      setInspection((prev) => ({
        ...prev,
        qrStatus: "success",
        location: property.name + " - " + randomLocation.name,
        currentStep: "form",
      }));
    }, 1500);
  };
  ...
  const handleManualOverride = () => {
    if (inspection.overrideReason) {
      setInspection((prev) => ({
        ...prev,
        manualOverride: true,
        location: property.name + " - Manual Override Location",
        currentStep: "form",
      }));
    }
  };
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="hidden sm:block">
                ...
                <p className="text-xs text-gray-500">
                  Progressive Enforcement Inspection
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                <Badge className="bg-blue-100 text-blue-800">
                  {property.equipmentCount} Equipment Items
                </Badge>
        ...
        <div className="space-y-6">
          ...
          {inspection.currentStep === "start" && (
            <Card className="border-2 border-blue-200 bg-blue-50">
              <CardHeader>
                <div className="flex items-center space-x-3">
                  <div className="w-20 sm:w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center">
                  ...
                  <div>
                    ...
                    <CardDescription>
                      Ready to begin equipment inspection with progressive
                      verification
                    </CardDescription>
                  </div>
                </div>
              ...
              <CardContent>
                <div className="space-y-4">
                  <Alert>
                    ...
                    <AlertDescription>
                      This inspection will use progressive enforcement with
                      smart fallbacks for location verification.
                    </AlertDescription>
                  </Alert>
                  <Button
                    onClick={() => {
                  ...
                  {inspection.gpsStatus === "success" && (
                    <Alert className="border-green-200 bg-green-50">
                      ...
                      <AlertDescription className="text-green-800">
                        GPS location verified! Coordinates:{" "}
                        {inspection.coordinates?.lat.toFixed(4)},{" "}
                        {inspection.coordinates?.lng.toFixed(4)}
                      </AlertDescription>
                    </Alert>
                  )}
                    ...
                    <div className="space-y-4">
                      <Alert className="border-red-200 bg-red-50">
                        ...
                        <AlertDescription className="text-red-800">
                          Unable to get GPS signal. You can retry or use
          ...
          {inspection.currentStep === "beacon" && (
            <Card className="border-2 border-purple-200">
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    <div className="w-20 sm:w-12 h-12 bg-purple-600 rounded-full flex items-center justify-center">
                      <Radio className="w-6 h-6 text-white" />
                    </div>
                    <div>
                      <CardTitle className="text-xl">
                        Step 2: Bluetooth Beacon Detection
                      </CardTitle>
                      <CardDescription>
                  ...
                  {inspection.beaconStatus === "checking" && (
                    <div className="flex items-center space-x-3 p-4 bg-purple-50 rounded-lg">
                      ...
                      <span className="text-purple-800">
                        Scanning for beacons... (0-30m range)
                      </span>
                    </div>
                  )}
                    ...
                    <div className="space-y-4">
                      <Alert className="border-amber-200 bg-amber-50">
                        ...
                        <AlertDescription className="text-amber-800">
                          No beacon found within range. Please scan the QR code
                          to continue.
                        </AlertDescription>
                      </Alert>
                      <Button
          ...
          {inspection.currentStep === "qr" && (
            <Card className="border-2 border-green-200">
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    <div className="w-20 sm:w-12 h-12 bg-green-600 rounded-full flex items-center justify-center">
                    ...
                    <div className="space-y-4">
                      <div className="p-6 border-2 border-dashed border-green-300 rounded-lg text-center bg-green-50">
                        ...
                        <p className="text-green-600 text-sm">
                          Look for QR codes on equipment labels or nearby signs
                        </p>
                      </div>
                      <Button
                        onClick={scanQR}
                  ...
                  {inspection.qrStatus === "success" && (
                    <div className="space-y-4">
                      <Alert className="border-green-200 bg-green-50">
                        <CheckCircle className="w-4 h-4 text-green-600" />
                        <AlertDescription className="text-green-800">
                          QR scanned successfully! You're in:{" "}
                    ...
                    <details className="group">
                      ...
                      <div className="mt-4 space-y-3 p-4 bg-gray-50 rounded-lg">
                        ...
                        >
                          ...
                          <SelectContent>
                            <SelectItem value="qr-damaged">
                              QR code damaged/unreadable
                            </SelectItem>
                            <SelectItem value="qr-missing">
                              QR code missing
                            </SelectItem>
                            <SelectItem value="camera-issue">
                              Camera not working
                            </SelectItem>
          ...
          {inspection.currentStep === "form" && (
            <Card className="border-2 border-indigo-200">
              <CardHeader>
                <div className="flex items-center space-x-3">
                  <div className="w-14 sm:w-12 h-12 bg-indigo-600 rounded-full flex items-center justify-center">
              ...
              <CardContent>
                <div className="space-y-6">
                  ...
                  <Button
                    ...
                    disabled={
                      !inspection.formData.equipmentCondition ||
                      !inspection.formData.notes
                    }
          ...
          {inspection.currentStep === "photo" && (
            <Card className="border-2 border-orange-200">
              <CardHeader>
                <div className="flex items-center space-x-3">
                  <div className="w-20 sm:w-12 h-12 bg-orange-600 rounded-full flex items-center justify-center">
                    <Camera className="w-6 h-6 text-white" />
                  </div>
                  <div>
                    <CardTitle className="text-xl">
                      Step 5: Photo Evidence (Required)
                    </CardTitle>
                    <CardDescription>
                ...
                <div className="space-y-4">
                  <Alert className="border-orange-200 bg-orange-50">
                    ...
                    <AlertDescription className="text-orange-800">
                      Photo evidence is mandatory and cannot be bypassed. This
                      helps verify inspection authenticity.
                    </AlertDescription>
                  </Alert>
                  ...
                  {!inspection.photoTaken ? (
                    <div className="space-y-4">
                      <div className="p-8 border-2 border-dashed border-orange-300 rounded-lg text-center bg-orange-50">
                        ...
                        <p className="text-orange-600 text-sm">
                          Capture the equipment, surroundings, or any issues
                          noted in your inspection
                        </p>
                      </div>
                      <Button
                        onClick={takePhoto}
                    ...
                    <div className="space-y-4">
                      <Alert className="border-green-200 bg-green-50">
                        <CheckCircle className="w-4 h-4 text-green-600" />
                        <AlertDescription className="text-green-800">
                          Photo captured successfully! Inspection is ready for
                          submission.
                        </AlertDescription>
                      </Alert>
